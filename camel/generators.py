...
class SystemMessageGenerator:
    ...
    def from_dict(
        ...
        return SystemMessage(
            role_name=role_name, role_type=RoleType.DEFAULT, meta_dict=meta_dict, content=sys_prompt
        )
    ...
    def from_dicts(
        ...
        if len(meta_dicts) != len(role_tuples):
            print("The number of meta_dicts and role_types should be the same.")
...
class CodeTaskPromptGenerator:
    ...
    def from_role_files(
        self, languages_path: str = "data/code/languages.txt", domains_path: str = "data/code/domains.txt"
